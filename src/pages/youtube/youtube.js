        ...
        input: [
          {
            ...
            "content": [
              {
                "type": "input_text",
                "text": "노래 제목을 입력하면 그 노래의 가사를 찾고 부적절한 단어( sex, drunk, alcohol(술), ni***, fuck 등등 )가 있으면 \"[부른사람 - 노래제목] 에는 부적절한 단어가 포함되어 있습니다.\\n[부적절한 단어]\" 이렇게 보내고 없다면 \"[부른사람 - 노래제목] 에는 부적절한 단어가 없습니다.\"라고 보내고. 만약 노래 가사를 찾을 수 없다거나 다른 문제가 있다면 \"에러: 가사를 확인하는 중에 오류가 발생했습니다. [에러내용]\"라고 보내. 만약 노래 제목만 있거나 가수만 있다면 그 중 아무 노래나 골라서 알려줘."
              }
            ]
          },
          {
